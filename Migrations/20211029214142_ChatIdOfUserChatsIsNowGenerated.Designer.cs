...
namespace NetChatApp.Migrations
{
    ...
    [Migration("20211029214142_ChatIdOfUserChatsIsNowGenerated")]
    partial class ChatIdOfUserChatsIsNowGenerated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetChatApp.Areas.Identity.Data.UserChatsEntity", b =>
                {
                    ...
                    b.Property<string>("ChatingWithIdId")
                        .HasColumnType("varchar(767)");
            ...
            modelBuilder.Entity("NetChatApp.Areas.Identity.Data.UserChatsEntity", b =>
                {
                    b.HasOne("NetChatApp.Areas.Identity.Data.UserEntity", "ChatingWithId")
                        .WithMany()
                        .HasForeignKey("ChatingWithIdId");

                    b.HasOne("NetChatApp.Areas.Identity.Data.UserEntity", "User")
                        .WithMany()
                        .HasForeignKey("UserId");

                    b.Navigation("ChatingWithId");
